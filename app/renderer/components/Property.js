...
class Property extends React.Component {
  ...
  types = [
      { name: 'string', attributes: [{ name: 'min', example: '=MI'}, { name: 'max', example: '=MAX'}]},
      { name: 'text', attributes: [{ name: 'min', example: '=MI'}, { name: 'max', example: '=MAX'}]},
      { name: 'html', attributes: [{ name: 'min', example: '=MI'}, { name: 'max', example: '=MAX'}]},
      { name: 'integer', attributes: [{ name: 'step', example: '=STE'}, { name: 'min', example: '=MI'}, { name: 'max', example: '=MA'}, { name: 'unit', example: '=UNIT'}]},
      { name: 'float', attributes: [{ name: 'step', example: '=STE'}, { name: 'min', example: '=MI'}, { name: 'max', example: '=MA'}, { name: 'unit', example: '=UNIT'}]},
      { name: 'double', attributes: [{ name: 'step', example: '=STE'}, { name: 'min', example: '=MI'}, { name: 'max', example: '=MA'}, { name: 'unit', example: '=UNIT'}]},
      { name: 'money', attributes: [{ name: 'step', example: '=STE'}, { name: 'min', example: '=MI'}, { name: 'max', example: '=MAX'}]},
      { name: 'set', attributes: [{ name: '', example: 'val1, val2, ...'}]},
      { name: 'enum', attributes: [{ name: '', example: 'val1, val2, ...'}]},
      { name: 'date', attributes: [{ name: 'step', example: '=STE'}, { name: 'min', example: '=MI'}, { name: 'max', example: '=MAX'}]},
      { name: 'time', attributes: [{ name: 'step', example: '=STE'}, { name: 'min', example: '=MI'}, { name: 'max', example: '=MAX'}]},
      { name: 'datetime', attributes: [{ name: 'step', example: '=STE'}, { name: 'min', example: '=MI'}, { name: 'max', example: '=MAX'}]}
  ]
              ...
              <Dialog show={this.state.showDialog}>
                  <form onSubmit={this.handleSubmit}>
                      ...
                      <div className="hint">
                          ...
                          { this.types.map(type=> <div>
                              { type.name }<i className="attributes">[{ type.attributes.map(attr => <span>
                                  <i className="attribute">{attr.name}</i>{attr.example} 
                              </span>) }]</i>
                          </div>) }
                      </div>
                  </form>
