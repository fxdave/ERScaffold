...
\begin{justify}
	...
	\begin{table}[]
		...
		\begin{tabular}{|l|l|l|l|l|}
			\hline
			Ezköz & \begin{tabular}[c]{@{}l@{}}Egyed\\ létrehozása\end{tabular} & \begin{tabular}[c]{@{}l@{}}Attribútum\\ hozzáadása\end{tabular} & Összekapcsolás & Törlés \\ \hline
	...
	A mérésnél 1 lépésnek számított a kattintás, az elnvezés, a húzás, a billentyű lenyomása (ha nem szöveg írásra használtuk) és a szöveg írása. A mért adatok azóta változhattak. 
