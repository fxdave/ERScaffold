      ...
      >
        ...
        <Dialog show={this.state.showDialog}>
          <form onSubmit={this.handleSubmit}>
            ...
            />
            <div className="hint">
              <b>EntityName : ContextName</b>
              <p>
                <b>EntityName</b> is the name of the entity in UpperCamelCase{" "}
                <br />
                <b>ContextName</b> is used for the repository layer, usually the
                name of the entity in plural UpperCamelCase
              </p>
            </div>
          </form>
        </Dialog>
